...
&DM = CM\label{eq2}
\end{align} 
Let $\vec{m_D_M}$ and $\vec{m_C_M}$ are direction vectors of DM and CM respectively. Then,
\begin{align}
\vec{m}_{DM} &= \vec{D} - \vec{M} = 
...
\begin{align}
\vec{m}_{DM} &= \vec{m}_{CM}\\
\implies{\vec{D} - \frac{\vec{A}+\vec{B}}{2}} &= {\vec{C} - \frac{\vec{A}+\vec{B}}{2}}\label{eqNew1}
\end{align}
\end{document}