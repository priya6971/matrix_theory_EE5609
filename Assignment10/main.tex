...
\end{align}
Now finding row space of $A$ is equivalent to finding column space of $A^T$. So, here we do elementary matrix multiplication of the $A^T$ matrix whose rows are given by $\alpha_i's$ and we evaluate that row reduced echelon form of the above matrix is:
\begin{align}\nonumber
