...
\begin{longtable}{|c|l|}
	...
	& Clearly, $\alpha_1$ = \myvec{1\\0\\2} $\in$ $W_1$\\
	...
	& Clearly, $\alpha_2$ = \myvec{1\\1\\0}, $\alpha_3$ = \myvec{0\\0\\1} $\in$ $W_2$\\
	& Therefore, $B_2$ = \{$\alpha_2,\alpha_3$\} is the basis for $W_2$\\
	& Let $T_2$ be the matrix induced by $T$ on $W_2$\\
	& $T_2\alpha_1$ = $T\alpha_2$ = \myvec{6&-3&-2\\4&-1&-2\\10&-5&-3} \myvec{1\\1\\0} = \myvec{3\\3\\5} = 3 \myvec{1\\1\\0} + 5 \myvec{0\\0\\1} = 3$\alpha_2$ + 5$\alpha_3$\\
