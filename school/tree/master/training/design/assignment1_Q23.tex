...
1 & 0}
\end{align}
RARA x = RAR b where RARA = kI, where I is the Identity Matrix and k is the constant which is equal to 118868 which is shown below

Now as we know Ax = b,

RARA x = RAR b
But as we know RARA = kI,

kIx = RAR b
So, kx = RAR b

Finally divide the LHS and RHS by k in order to get the value of x.
